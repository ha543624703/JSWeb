...
<div class="navMenu">
        <div class="navBox">
            ...
            <div class="navData">
                <ul>
                    <li><a href="http://218.87.30.159:8080/JSWeb/getMoreNews" class="navCurrent">学院新闻</a></li>
                    <li><a href="http://218.87.30.159:8080/JSWeb/getMoreDynamic" class="navCurrent">部门动态</a></li>  
                    <li><a href="http://218.87.30.159:8080/JSWeb/getMoreNotice" class="navCurrent">通知公告</a></li> 
                </ul>
            </div>
        </div>
            ...
            <div class="navList">
                <ul>
                    <c:forEach var="item" items="${listdynamic}" varStatus="status" begin="0"> 
                          <li><a href="http://218.87.30.159:8080/JSWeb/getNotice?articleId=${item.id}" target="_blank">${item.title}</a></li>     
                    </c:forEach>                
                </ul>
            </div>
        </div>
    ...
    function tt(dd){
   	 $.ajax({
 		...
 		success : function(data) {
			...
			{
				var item = list[i];
				var _detail = '<li><span>['+item.update_time+']</span><a href="http://218.87.30.159:8080/JSWeb/getDynamic?articleId='+item.id+'" target="_blank">'+item.title+'</a></li>';
